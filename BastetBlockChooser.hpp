...
namespace std{namespace tr1{
    template<> struct hash<Bastet::FallingBlock>{
      size_t operator()(const Bastet::FallingBlock &fb) const{
	static boost::hash<Bastet::FallingBlock> h;
	return h(fb);
      }
    };
  }}
...
namespace Bastet{
  ...
  public:
    WellVisitor(){}
    virtual void Visit(const Well *well, Vertex v){};
    virtual ~WellVisitor(){};
  };
